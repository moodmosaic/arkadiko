      ...
      {({ open }) => (
        <>
          ...
          >
            <Menu.Items
              static
              className="absolute top-0 z-10 w-48 mx-3 mt-1 origin-top-right bg-white divide-y divide-gray-200 rounded-md shadow-lg dark:bg-zinc-900 dark:divide-zinc-600 right-7 ring-1 ring-black ring-opacity-5 focus:outline-none"
            >
